...
try:
    from models.feillistefigur import feilliste_figurer # Tester å lage egendefinerte figurer
    egendefinerte_figurer = True
except:
    print("Ingen egendefinerte figurer")
    egendefinerte_figurer = False
...
def feilliste_figur_test(feilliste, enhet_rad, tabelldata):
    innhold = []
    if egendefinerte_figurer == True:
        print("Eksperiment")
        innhold =  feilliste_figurer(feilliste, enhet_rad, tabelldata)
    return innhold
